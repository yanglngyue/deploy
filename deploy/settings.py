...
SECRET_KEY = '-p*aw7d#p0d^gynw_1trskf528i*=4-asfms+$$o-n045g-(45'
...
#                 'filename': '/home/linux/django/logs/django.log',  #这是将普通日志写入到日志文件中的方法，
#                 'formatter': 'standard'
#     },
#     'loggers': {
#         'django.db.backends': {
...
LOGGING_DIR = "D:\Python\deploy\logs"
...
LOGGING = {
    ...
    'handlers': { # 处理器，在这里定义了两个个处理器
        ...
        'file': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': 'django.log',  #这是将普通日志写入到日志文件中的方法，
            'formatter': 'standard'
        },
        'default': {
            'level':'DEBUG',
            'class':'logging.handlers.RotatingFileHandler',
            'filename': 'django-test.log',     #日志输出文件
